...
function OrganizationForm({
  ...
  const handleMultiSelectChange = (name: string, values: string[]) => {
    setDetails((prev: OrganizationFormProps["details"]) => ({
      ...prev,
      [name]: values,
    }));
    ...
    <div className="text-sm space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Describe this platform, tell us what you do."
          required
        />
        {errors.description && touched.description && (
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700">
          Platform/website link <span className="text-red-500">*</span>
        </label>
        <input
          type="url"
          name="websiteLink"
